...
export class HistogramTests {
  ...
  @HistogramBefore('before.with.derived.tags', 39, (arg: string) => {
  ...
  @HistogramAfter('after.with.derived.tags', 40, (arg: string, returnValue: string) => {
  ...
  @HistogramOnError('onerror.with.derived.tags', 40, (arg: string, error: any) => {
