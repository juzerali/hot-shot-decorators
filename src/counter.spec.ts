...
describe("Increment", () => {
  ...
  describe("IncrementBeforeWrapper", () => {
    it("should increment by 1 and use stats name as Class.methodName by default", () => {
      ...
      verify(
        mockedStatsD.increment(
          "CounterTests.incBeforeAllDefaults",
          1,
          objectContaining({})
        )
      ).once();
    ...
    it("decorated method should execute in correct context", async () => {
      ...
      verify(
        mockedStatsD.increment("before.with.context", 98, objectContaining({}))
      ).once();
    });
    ...
    it("should increment 1 be default", () => {
      ...
      verify(
        mockedStatsD.increment("before.default.value", 1, anything())
      ).once();
    });
    ...
    it("should inspect arguments", () => {
      const test = new CounterTests();
      const result = test.incBeforeWithArgs({
    ...
    it("should default to 1 when derivative function throws", () => {
      ...
      const result = test.incBeforeWithFunctionDerivationThrows(
        { amount: 149 },
        {}
      );
      expect(result).toEqual(
        "incBeforeWithFunctionDerivationThrows.returnValue"
      );
      verify(
        mockedStatsD.increment("before.derive.throws", 1, anything())
      ).once();
    });
  });
  ...
  describe("IncrementAfterWrapper", () => {
    it("should increment by 1 and use stats name as Class.methodName by default", () => {
      ...
      verify(
        mockedStatsD.increment(
          "CounterTests.incAfterAllDefaults",
          1,
          objectContaining({})
        )
      ).once();
    ...
    it("should increment 1 by default", () => {
      ...
      verify(
        mockedStatsD.increment("after.default.value", 1, anything())
      ).once();
    });
    ...
    it("should inspect arguments", () => {
      const test = new CounterTests();
      const result = test.incAfterWithArgs({
  ...
  describe("IncrementOnErrorWrapper", () => {
    it("should increment by 1 and use stats name as Class.methodName by default", () => {
      ...
      verify(
        mockedStatsD.increment(
          "CounterTests.incOnErrorAllDefaults",
          1,
          objectContaining({})
        )
      ).once();
    ...
    it("should increment 1 by default", () => {
      ...
      verify(
        mockedStatsD.increment("onerror.default.value", 1, anything())
      ).once();
    });
    ...
    it("should inspect arguments", () => {
      const test = new CounterTests();
      expect(() =>
        test.incOnErrorWithArgs({
          a: { deeply: { nested: { property: [0, 1, 2, 3, 87] } } },
        })
      ).toThrow();
      verify(
        mockedStatsD.increment("onerror.with.args", 87, anything())
      ).once();
    });
